...
@section('title', 'Добавить статью бюджета')
@section('page-title', 'Добавить статью бюджета')

@section('content')
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="card">
            <form action="{{ route('tenant.budget.store', $event) }}" method="POST">
                @csrf
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="estimated_amount" id="estimated_amount" value="{{ old('estimated_amount', 0) }}" step="0.01" min="0" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="actual_amount">Фактическая сумма (₽)</label>
                                <input type="number" name="actual_amount" id="actual_amount" value="{{ old('actual_amount', 0) }}" step="0.01" min="0" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
