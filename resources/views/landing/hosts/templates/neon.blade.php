...
<head>
    ...
    <style>
        :root { --bg: #07111f; --cyan: #55f7ff; --lime: #ddff4f; --pink: #ff3f9d; --orange: #ff8a00; --text: #f8fbff; }
        * { box-sizing: border-box; }
        body { margin: 0; color: var(--text); font-family: "Space Grotesk", sans-serif; background: radial-gradient(circle at 15% 20%, rgba(85,247,255,.28), transparent 28%), radial-gradient(circle at 85% 10%, rgba(255,63,157,.34), transparent 30%), radial-gradient(circle at 55% 95%, rgba(255,138,0,.24), transparent 30%), linear-gradient(135deg, #07111f, #111827); }
        ...
        .hero { border: 1px solid rgba(255,255,255,.18); border-radius: 40px; padding: clamp(28px, 6vw, 70px); background: linear-gradient(135deg, rgba(255,255,255,.09), rgba(85,247,255,.06)); box-shadow: 0 0 80px rgba(85,247,255,.16), 0 0 120px rgba(255,63,157,.12); overflow: hidden; position: relative; }
        ...
        .card { border-radius: 28px; padding: 24px; background: linear-gradient(145deg, rgba(255,255,255,.1), rgba(255,63,157,.08)); border: 1px solid rgba(255,255,255,.14); box-shadow: inset 0 0 34px rgba(85,247,255,.06); }
