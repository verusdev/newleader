...
<head>
    ...
    <style>
        :root { --paper: #f4f0e8; --ink: #171717; --red: #9f1d2d; --line: rgba(23,23,23,.18); }
        * { box-sizing: border-box; }
        body { margin: 0; background: var(--paper); color: var(--ink); font-family: Montserrat, sans-serif; }
        .page { min-height: 100vh; padding: 28px; background-image: linear-gradient(var(--line) 1px, transparent 1px), linear-gradient(90deg, var(--line) 1px, transparent 1px); background-size: 72px 72px; }
        .shell { max-width: 1200px; margin: 0 auto; border: 2px solid var(--ink); background: rgba(244,240,232,.92); }
        ...
        .side { padding: 34px; display: flex; flex-direction: column; justify-content: space-between; background: var(--red); color: white; }
        .side strong { font-family: "Cormorant Garamond", serif; font-size: 72px; display: block; }
        .contact { color: var(--ink); background: white; display: inline-block; padding: 14px 20px; text-decoration: none; font-weight: 800; margin-top: 22px; }
