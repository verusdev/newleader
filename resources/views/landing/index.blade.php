...
<div class="landing-hero text-center">
    <div class="container">
        <h1 class="display-4 font-weight-bold mb-3">Создайте свой магазин за 5 минут</h1>
        <p class="lead mb-4">Мультитенантная платформа с оплатой через ЮKassa</p>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 text-center mb-4">
                ...
                <h4>1. Выберите тариф</h4>
                <p class="text-muted">Подберите подходящий план для вашего бизнеса</p>
            </div>
            <div class="col-md-4 text-center mb-4">
                <div class="bg-white rounded-circle shadow p-4 d-inline-block mb-3">
                    <i class="fas fa-user-plus fa-3x text-primary"></i>
                </div>
                <h4>2. Зарегистрируйтесь</h4>
                <p class="text-muted">Заполните форму и оплатите подписку</p>
            </div>
            <div class="col-md-4 text-center mb-4">
                <div class="bg-white rounded-circle shadow p-4 d-inline-block mb-3">
                    <i class="fas fa-store fa-3x text-primary"></i>
                </div>
                <h4>3. Начните работать</h4>
                <p class="text-muted">Ваш магазин готов к приёму заказов</p>
            </div>
        </div>
    </div>
</div>
