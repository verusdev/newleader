...
Мультитенантное SaaS-приложение с оплатой подписки через ЮKassa. Пользователи регистрируются через лендинг, выбирают тариф, оплачивают подписку — после оплаты автоматически создаётся их тенант (изолированный магазин).
